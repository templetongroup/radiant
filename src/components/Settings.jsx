...
const GUIDE = [
  {
    title: 'Chat & agents',
    items: [
      ['You can always see whether the agent is working', 'A status strip sits just above the message box for as long as a turn is running, and it stays put when you scroll. It says what is happening \u2014 waiting for the model, thinking, writing, or the name of the tool it is running \u2014 how long the turn has taken, and it has a Stop button. If nothing has happened for 25 seconds and no tool is running, it turns red and tells you how long it has been quiet, so a stuck turn looks different from a busy one. A tool that takes minutes is not called stuck: it is named instead.'],
